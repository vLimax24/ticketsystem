        ...
        <div className="flex">
          <DetailSidebar>
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <button className="block w-full">
                  <SidebarItem icon={<Check size={20} />} text="Mark As Done" />
                </button>
              </AlertDialogTrigger>
              <AlertDialogContent>
                <AlertDialogHeader>
            ...
            <Dialog>
              ...
              <DialogContent className="sm:max-w-[425px]">
                ...
                <DialogFooter>
                  <Button type="submit" onClick={shareTask}>
                    OK
                  </Button>
                </DialogFooter>
              </DialogContent>
            ...
            <SidebarItem icon={<Pen size={20} />} text="Change Status" />
            <hr className="my-3" />
          ...
          <div className="ml-5 md:ml-20 mt-3.5">
            <div className="flex flex-col">
              <h1 className="text-3xl md:text-[3rem] lg:text-[4rem] lg:mt-2 font-bold h-fit">
                {report?.name}
              </h1>
            ...
            <AttachedFiles files={report?.files ? report.files : []} />
          </div>
        </div>
        <div>
